...
| GitHub button opens the repository directly in a new tab without opener redirect | Implemented | Deployed in run #105 | Pending live test |
...
| Check | Source | Deployment | Live verification |
|---|---|---|---|
| Project Map primary sequence is Hydra Launcher → Setup → Build → Security Research → Research → Project Control → Created Notes | Implemented | Deployed in run #105 | Pending live test |
| Project Map clicks update follower sidebar and main document | Implemented | Deployed in run #105 | Pending live test |
| Detailed-sidebar navigation updates Project Map active category | Implemented | Deployed in run #105 | Pending live test |
| Project Map Hydra Launcher targets #guide-top | Implemented | Deployed in run #105 | Pending live test |
| Final detailed-sidebar item remains reachable | Implemented | Deployed in run #105 | Pending live test |
| Project Control buttons transparent by default | Implemented | Deployed in run #105 | Pending live test |
| Capitalized navigation labels | Implemented | Deployed in run #105 | Pending live test |
| Canonical original visual theme preserved for both rails | Implemented | Deployed in run #105 | Pending live test |
| Hero GitHub repo button is direct new-tab repository link | Implemented | Deployed in run #105 | Pending live test |
